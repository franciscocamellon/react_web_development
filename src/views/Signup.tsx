...
import logo from "../assets/img/logo_98x98.png";
  ...
  return (
    ...
    >
      <Grid sx={styles.boxAdjustment} container={true}>
        ...
        <Grid sx={{ ...styles.centerBox, ...styles.marginTop }} item={true} size={{ xs: 12 }}>
        ...
        <Grid sx={styles.marginTop} item={true} size={{ xs: 12 }}>
          <TextField
            label="E-mail"
            fullWidth={true}
            onChange={(event) => handleOnChange(data, setData, event.target.value, "email")}
        ...
        <Grid sx={styles.marginTop} item={true} size={{ xs: 12 }}>
          <TextField
            label="Senha"
            fullWidth={true}
            onChange={(event) => handleOnChange(data, setData, event.target.value, "password")}
            type="password"
        ...
        <Grid sx={styles.marginTop} item={true} size={{ xs: 12 }}>
          <TextField
            ...
            fullWidth={true}
            onChange={(event) => handleOnChange(data, setData, event.target.value, "confirm_password")}
            type="password"
